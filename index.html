...
<body>
    ...
    <div class="container">
        <header>
            <h1>DanzHosting</h1>
            <p class="subtitle">Your Universal All Payment Solution By DanzHosting</p>
        </header>
        ...
        <div class="payment-options">
            ...
            <div class="payment-card">
                ...
                <div class="account-info" data-number="083857243960">
                    <div class="account-number">0838-5724-3960</div>
                </div>
                <div class="button-group">
                    <button class="payment-button" id="pay-with-dana">Pay with DANA</button>
                    <a href="https://wa.me/62838?text=Halo%20admin,%20saya%20ingin%20konfirmasi%20pembayaran%20via%20DANA" class="payment-button whatsapp-button" target="_blank">Confirm via WA</a>
                </div>
            </div>
            ...
            <div class="payment-card">
                ...
                <div class="button-group">
                    ...
                    <a href="https://wa.me/6283857243960?text=Halo%20admin,%20saya%20ingin%20konfirmasi%20pembayaran%20via%20GoPay" class="payment-button whatsapp-button" target="_blank">Confirm via WA</a>
                </div>
            </div>
            ...
            <div class="payment-card">
                ...
                <div class="button-group">
                    ...
                    <a href="https://wa.me/6283857243960?text=Halo%20admin,%20saya%20ingin%20konfirmasi%20pembayaran%20via%20OVO" class="payment-button whatsapp-button" target="_blank">Confirm via WA</a>
                </div>
            </div>
            ...
            <div class="payment-card">
                ...
                <div class="account-info" data-number="1234567890">
                    <div class="account-number">1234567890</div>
                </div>
                <div class="button-group">
                    <button class="payment-button" id="pay-with-seabank">Pay with SeaBank</button>
                    <a href="https://wa.me/6283857243960?text=Halo%20admin,%20saya%20ingin%20konfirmasi%20pembayaran%20via%20SeaBank" class="payment-button whatsapp-button" target="_blank">Confirm via WA</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal" id="qris-modal">
        <div class="modal-content">
            ...
            <div class="qris-image">
                <img src="https://files.catbox.moe/o3iiuy.png" alt="QRIS Code">
            </div>
            ...
            <div class="button-group" style="margin-top: 1rem;">
                ...
                <a href="https://wa.me/6283857243960?text=Halo%20admin,%20saya%20ingin%20konfirmasi%20pembayaran%20via%20QRIS" class="payment-button whatsapp-button" target="_blank">Confirm via WA</a>
            </div>
        </div>
    </div>
    ...
    <!-- Footer -->
    <footer>
        <p>&copy; 2025 DanzHost. All rights reserved.</p>
        <p>Website All Payment By Danii Host</p>
    </footer>
